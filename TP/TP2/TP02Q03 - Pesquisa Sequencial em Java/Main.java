...
class Filme {
     ...
     */
    public static boolean pesquisaSequencial2(Filme[] filmes, String entrada) {
        boolean existe = false;
        int comparacoes = 0;
        for (int i = 0; i < filmes.length; i++) {
            comparacoes++;
            if (filmes[i].getNome().equals(entrada)) {
...
class Main {
    ...
    public static void main(String[] args) throws ParseException, IOException {
        ...
        // Criacao do log
        File log = new File("705113_sequencial.txt");
        log.createNewFile();
        ...
        for (int i = 0; i < numPesquisa; i++) {
            ...
            existe = Filme.pesquisaSequencial2(filmes, pesquisa[i]);
            if (existe == true) {
