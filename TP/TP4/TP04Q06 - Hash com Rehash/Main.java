...
class Hash {
    ...
    public void inserir(Filme elemento) {
        ...
        if (tabela[indice] == null) {
            ...
            // System.out.println("Tabela normal " + indice + " " +
            // elemento.getTituloOriginal());
        } else {
            indice = rehash(elemento.getTituloOriginal());
            if (tabela[indice] == null) {
                tabela[indice] = elemento;
                // System.out.println("Rehash" + indice + " " + elemento.getTituloOriginal());
            } else {
                // System.out.println("Erro ao inserir com rehash " + indice + " " +
                // elemento.getTituloOriginal());
            }
        }
...
class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        File log = new File("705113_hashRehash.txt");
        log.createNewFile();
