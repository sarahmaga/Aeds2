...
class Pilha {
    ...
    public void imprimirPilhaOrdemRemocao() {
    ...
    public void imprimirPilha() {
        imprimirPilhaRec(this.topo);

    }

    private void imprimirPilhaRec(Celula i) {

        if (i != null) {
            imprimirPilhaRec(i.prox);
            System.out.println("[" + contador + "] " + i.filme.imprimir2());
        }
        contador++;
    ...
    public void reempilhar() throws Exception {
        Pilha aux = new Pilha();
        for (Celula i = topo; i != null; i = i.prox) {
            aux.inserir(i.filme);
